...
/**
 * creates reports on the composition of the institution's employees
 */
public class employeesReportCreator {
    private static final Logger logger = Logger.getLogger(employeesReportCreator.class.getName());
     ...
     * </p>
     */
    public employeesReportCreator() {

        // Month is strange -1??
        date = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
        String path = "./examplesPDF/Employee Reports/Employees " + date + ".pdf";
        ...
        logger.info("EmployeeReport was created");
    }
    ...
    private void addEmployeeTable() {
        ...
        table.addHeaderCell(new Cell().add(new Paragraph("Post")));
        table.addHeaderCell(new Cell().add(new Paragraph("Salary")));
        ...
        for (Employee employee : employees) {
            ...
            table.addCell(new Cell().add(new Paragraph(employee.getPost())));
